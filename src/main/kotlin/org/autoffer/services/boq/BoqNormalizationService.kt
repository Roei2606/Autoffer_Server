...
import org.autoffer.services.catalog.ProfileCatalogEntry
...
class BoqNormalizationService(
    ...
    fun normalize(doc: org.autoffer.integrations.docai.DocAiResponse, skipUnparseable: Boolean = true): Result {
        ...
        mergedById.entries.sortedBy { it.key }.forEach { (sourceId, f) ->
            ...
            var (w, h) = dims
            val usageGuess: UsageAndAliasResolver.UsageGuess = UsageAndAliasResolver.guessUsage(f["configuration"], f["opening"])
