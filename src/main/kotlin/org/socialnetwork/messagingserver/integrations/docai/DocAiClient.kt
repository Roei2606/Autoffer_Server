...
import org.socialnetwork.messagingserver.config.DocAiPythonProperties
...
class DocAiClient(
    ...
    fun processPdf(pdfBytes: ByteArray, filename: String = "boq.pdf"): DocAiResponse {
